...
class CalcEngine
{
 ...
 private:
  ...
  static const KNumber & deg_to_rad_factor();
  static const KNumber & gra_to_rad_factor();
  static const KNumber & rad_to_deg_factor();
  static const KNumber & rad_to_gra_factor();

  const KNumber Deg2Rad(const KNumber &x) const { return deg_to_rad_factor() * x; }
  const KNumber Gra2Rad(const KNumber &x) const { return gra_to_rad_factor() * x; }
  const KNumber Rad2Deg(const KNumber &x) const { return rad_to_deg_factor() * x; }
  const KNumber Rad2Gra(const KNumber &x) const { return rad_to_gra_factor() * x; }
