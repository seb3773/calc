...
#ifndef _CALC_CONST_BUTTON_H
#define _CALC_CONST_BUTTON_H

#include <tdelocale.h>
#include "calc_button.h"


class CalcConstButton : public CalcButton
{
TQ_OBJECT
  ...
  CalcConstButton(TQWidget *parent, int but_num, const char * name = 0);
  
  CalcConstButton(const TQString &label, TQWidget *parent, int but_num, const char * name = 0,
