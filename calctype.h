...
/* should be detected by autoconf and defined in config.h
   ...
   is used all over calc's sources to determine whether 
   long double of double is the fundamental data type for calc*/
...
#define CALC_LONG_MIN	LLONG_MIN
#define CALC_LONG_MAX	LLONG_MAX
#define CALC_ULONG_MAX	ULLONG_MAX
#define CALC_LONG	long long
#define HAVE_LONG_LONG
#define STRTOUL         strtoull
#else
#if defined(LONG_LONG_MAX) && defined(HAVE_LONG_DOUBLE)
#define CALC_LONG_MIN	LONG_LONG_MIN
#define CALC_LONG_MAX	LONG_LONG_MAX
#define CALC_ULONG_MAX	ULONG_LONG_MAX
#define CALC_LONG	long long
#define HAVE_LONG_LONG
#define STRTOUL         strtoull
#else
#define CALC_LONG_MIN	LONG_MIN
#define CALC_LONG_MAX	LONG_MAX
#define CALC_ULONG_MAX	ULONG_MAX
#define CALC_LONG	long
